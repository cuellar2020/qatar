...
class PartidoController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select('pais2.imagen as pais2','pais.imagen as pais1','pais.nombre as nombrep1','pais2.nombre as nombrep2',
        ...
        return view('usuario.partidos')->with('jornadas1',$jornadas1)
